...
const Cart = () => {
  ...
  useEffect(() => {
    //cuando cambie el valor de cartItem, actualiza el valor de productsLength
    setProductLength(
  ...
  return (
    <div className="cartContainer">
      ...
      >
        ...
        {!cartOpen && <div className="cartText">{productsLength}</div>}
            ...
            {cartItems.length === 0 ? (
              ...
              <div className="productsContainer">
                {cartItems.map((item, i) => (
                  <ItemCart item={item} key={i  }></ItemCart>
                ))}
              </div>
            )}
